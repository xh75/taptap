...
| **Le décor se résout en…** ✅ implémenté | L'onde enfle et pulse (amplitude ×1,3, battement). | Les couronnes se **verrouillent en engrenage** : rotation à crans (420 ms), dents alternées, **œil pulsant** au centre. | Le flux se **condense en globe** : croûte lumineuse, dehors éteint, **veines pulsantes** sous la surface (u_boss, fondu lissé). |
